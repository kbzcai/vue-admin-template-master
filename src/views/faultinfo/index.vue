<template>
  <div>
    <el-form :inline="true" :model="faultHistoryCondition" class="demo-form-inline"
      ...
      <el-form-item>
        <el-date-picker type="date" placeholder="选择开始日期" v-model="faultHistoryCondition.beginTime"></el-date-picker>
      </el-form-item>
      <el-form-item>
        <el-date-picker type="date" placeholder="选择结束日期" v-model="faultHistoryCondition.endTime"></el-date-picker>
      </el-form-item>
      <el-form-item>
