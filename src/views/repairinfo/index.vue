  ...
  <div>
    <el-form :inline="true" :model="repairHistoryCondition" class="demo-form-inline"
      ...
      <el-form-item label="设备号">
        <el-autocomplete
          class="inline-input"
          v-model="repairHistoryCondition.equipmentNo"
      ...
      <el-form-item>
        <el-date-picker type="datetime" placeholder="选择开始日期" v-model="repairHistoryCondition.beginTime"
                        :picker-options="pickerOptions"></el-date-picker>
      </el-form-item>
      <el-form-item>
        <el-date-picker type="datetime" placeholder="选择结束日期" v-model="repairHistoryCondition.endTime"
                        :picker-options="pickerOptions"></el-date-picker>
      </el-form-item>
      <el-form-item>
...
export default {
  ...
  methods: {
    ...
    queryAllEquipmentNo() {
      let list = []
      const _this = this
      this.$axios.get('http://localhost:8181/mesEquipmentRepairHistory/queryAllEquipmentNo').then(function (resp) {
